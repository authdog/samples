# authdog lidar on fastify

Smallest Fastify starter for reacting to Lidar-relevant identity
...
This completes Wave 2 for `fastify`. See the catalog for other stacks.
