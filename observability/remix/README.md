# authdog observability on remix

Smallest Remix starter for Authdog observability: a signed-webhook
action and an Events API read path.
...
Lidar integration for this stack is Planned: `lidar/remix`.
