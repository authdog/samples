# authdog observability on express

Smallest Express starter for Authdog observability: a signed-webhook
receiver and an Events API read path.
...
Lidar integration for this stack is Planned: `lidar/express`.
